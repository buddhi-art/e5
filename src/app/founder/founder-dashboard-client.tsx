...
const colorMap = {
    ...
    emerald: { bg: 'bg-emerald-50 dark:bg-emerald-950/30', text: 'text-emerald-600 dark:text-emerald-400', badge: 'bg-emerald-500/10 text-emerald-500' },
    amber: { bg: 'bg-amber-50 dark:bg-amber-950/30', text: 'text-amber-600 dark:text-amber-400', badge: 'bg-amber-500/10 text-amber-500' },
}
        ...
        <div className="space-y-8 lg:space-y-12 overflow-x-hidden w-full max-w-full">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-primary-container to-surface-container-lowest ring-1 ring-primary/20 p-5 card-morph morph-fade-in morph-delay-8">
                ...
                <div className="mt-3 pt-3 border-t border-primary/20 flex items-center justify-center gap-2">
                    <span className={cn('w-2 h-2 rounded-full animate-pulse', healthScore >= 80 ? 'bg-emerald-500' : healthScore >= 60 ? 'bg-amber-500' : 'bg-red-500')} />
