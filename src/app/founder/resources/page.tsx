    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 morph-fade-in morph-delay-2">
                ...
                <div className="rounded-2xl bg-surface-container-lowest p-4 ring-1 ring-outline-variant/40 card-morph">
                    <div className="w-9 h-9 rounded-xl bg-red-50 dark:bg-red-950/30 text-red-500 flex items-center justify-center mb-2">
                                    ...
                                    {items.map(eq => (
                                        <div key={eq.id}
                                            ...
                                            <Badge variant="outline" className={cn(
                                                ...
                                                eq.status === 'available' ? 'bg-emerald-50 dark:bg-emerald-950/30 text-emerald-500 border-emerald-500/30' :
                                                    eq.status === 'checked_out' ? 'bg-amber-50 dark:bg-amber-950/30 text-amber-500 border-amber-500/30' :
                                                        eq.status === 'maintenance' ? 'bg-red-50 dark:bg-red-950/30 text-red-500 border-red-500/30' :
                            ...
                            {maintenanceRecords.map(mr => (
                                <div key={mr.id} className="px-5 py-3 flex items-center justify-between">
                                    ...
                                    <div className="text-right shrink-0 ml-4">
                                        <Badge variant="outline" className={cn(
                                            'text-[10px]',
                                            mr.status === 'completed' ? 'bg-emerald-50 dark:bg-emerald-950/30 text-emerald-500 border-emerald-500/30' :
                                                mr.status === 'in_progress' ? 'bg-amber-50 dark:bg-amber-950/30 text-amber-500 border-amber-500/30' :
