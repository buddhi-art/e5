        ...
        <div className="flex flex-col h-[calc(100vh-10rem)] space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 shrink-0">
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 shadow-sm">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Overdue</span>
                        <span className={`text-lg font-bold ${overdueTasks.length > 0 ? 'text-red-500' : 'text-emerald-500'}`}>
                            {overdueTasks.length}
                        </span>
                    </div>
                    {overdueTasks.length > 0 && (
                        <p className="text-[10px] text-red-600 dark:text-red-400 mt-0.5 truncate">
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 shadow-sm">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Budget Alert</span>
                        <span className={`text-lg font-bold ${budgetAlerts.length > 0 ? 'text-amber-500' : 'text-emerald-500'}`}>
                            {budgetAlerts.length}
                        </span>
                    </div>
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 shadow-sm">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-lg font-bold text-sky-500">{allProjects.length}</span>
                    </div>
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 shadow-sm">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Most Loaded</span>
            ...
            <div className="flex flex-wrap gap-2 shrink-0 items-center">
                ...
                <div className="flex items-center gap-3 ml-auto text-xs text-zinc-500">
                    ...
                    <span className="flex items-center gap-1">
                        <span className="w-2.5 h-2.5 rounded bg-red-100 dark:bg-red-900/20 border border-red-300 inline-block"></span> Holiday
                    </span>
                </div>
            </div>

            {/* Month Grid */}
            <div className="flex-1 overflow-auto border border-zinc-200 dark:border-zinc-800 rounded-xl bg-white dark:bg-zinc-900 shadow-sm p-4">
                <CalendarMonthGrid
