      ...
      <div className="xl:col-span-2 space-y-6">
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input name="title" required defaultValue={initialData?.title} placeholder="e.g. Phase 1 Production" className="bg-zinc-50 dark:bg-zinc-800/50" />
              </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea name="description" defaultValue={initialData?.description} placeholder="Additional details..." className="bg-zinc-50 dark:bg-zinc-800/50 min-h-[80px]" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-800 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button type="button" onClick={addItem} variant="outline" size="sm" className="bg-white dark:bg-zinc-800">
              ...
              <div key={item.id} className="flex flex-col md:flex-row gap-4 items-start md:items-end">
                ...
                <div className="w-full md:w-32 space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-zinc-100 dark:bg-zinc-900 border-zinc-200 dark:border-zinc-700 text-zinc-500"
                  />
                </div>
                <div className="pb-1">
                  <Button type="button" onClick={() => removeItem(item.id)} variant="ghost" className="text-red-500 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-950/50" disabled={items.length === 1}>
        ...
        <Card className="bg-white dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-800 shadow-sm">
          ...
          <CardContent>
            <Textarea name="notes" defaultValue={initialData?.notes} placeholder="Terms and conditions, payment details..." className="bg-zinc-50 dark:bg-zinc-800/50 min-h-[100px]" />
          </CardContent>
        </Card>
      </div>

      <div className="xl:col-span-1 space-y-6">
        <Card className="bg-white dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-800 sticky top-24 shadow-sm">
          <CardHeader>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Select value={discountType} onValueChange={(val) => val && setDiscountType(val)}>
                    <SelectTrigger className="w-24 bg-zinc-50 dark:bg-zinc-800/50 h-8">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                  ...
                  <Input
                    ...
                    className="flex-1 bg-zinc-50 dark:bg-zinc-800/50 h-8"
                    placeholder="0"
                  />
                </div>
                {discountAmount > 0 && (
              ...
              <div className="flex items-center justify-between gap-4">
                <span className="text-sm text-zinc-500 whitespace-nowrap">Tax Rate (%)</span>
                <Input
                  type="number"
                  min="0"
                  max="100"
                  ...
                  className="w-24 bg-zinc-50 dark:bg-zinc-800/50 h-8 text-right"
                />
              </div>
              <div className="flex justify-between text-sm">
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  className="bg-zinc-50 dark:bg-zinc-800/50 h-8"
                />
              </div>

              <div className="pt-3 border-t border-zinc-200 dark:border-zinc-800 flex justify-between">
                <span className="font-semibold text-zinc-900 dark:text-white">Grand Total</span>
                <span className="font-bold text-sky-600 dark:text-sky-400 text-lg">{grandTotal.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {currency}</span>
              </div>
        ...
        {selectedClient && (
          <Card className="bg-zinc-50 dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-800 shadow-sm">
            ...
            <CardContent className="text-sm text-zinc-600 dark:text-zinc-400 space-y-1">
              <p className="font-medium text-zinc-900 dark:text-white">{selectedClient.company_name}</p>
