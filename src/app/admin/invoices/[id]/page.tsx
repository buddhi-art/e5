 ...
 *,
 ...
 <Button type="submit" variant="outline" className="bg-m3-warning-subtle text-m3-warning border-m3-warning hover:bg-m3-warning-subtle hover:text-m3-warning">
 <Send className="w-4 h-4 mr-2" />
 Send Invoice
 </Button>
 </form>
 <Link href={`/admin/invoices/${invoice.id}/edit`} className="inline-flex items-center justify-center rounded-lg border border-outline-variant bg-surface-container-lowest hover:bg-surface-container-high h-8 px-2.5 text-sm font-medium gap-1.5">
 ...
 <span className="text-m3-warning">- {Number(invoice.discount_amount || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {invoice.currency}</span>
 </div>
 )}
 {invoice.tax_rate > 0 && (
 <div className="flex justify-between text-on-surface-variant text-sm">
 ...
 <div className="flex justify-between text-m3-info text-sm font-medium">
 ...
 <div className="flex justify-between text-m3-success text-sm font-medium">
 ...
 <InvoiceTimeline entries={timelineEntries || []} />
