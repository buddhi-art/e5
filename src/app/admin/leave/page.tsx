...
export default async function AdminLeaveDashboard() {
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-white mb-2">Leave Management</h1>
        <p className="text-zinc-600 dark:text-zinc-400">Manage employee leave requests, balances, and holidays.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-medium text-zinc-500">On Leave Today</CardTitle>
            <Users className="w-4 h-4 text-sky-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{onLeaveToday || 0}</div>
            <p className="text-xs text-zinc-500 mt-1">Currently away</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 shadow-sm hover:border-sky-500/50 transition-colors">
          <CardHeader>
          ...
          <CardContent>
            <p className="text-sm text-zinc-500 mb-4">Review, approve, or reject employee leave requests.</p>
        ...
        <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 shadow-sm hover:border-sky-500/50 transition-colors">
          ...
          <CardContent>
            <p className="text-sm text-zinc-500 mb-4">Manage employee leave quotas and remaining balances.</p>
        ...
        <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 shadow-sm hover:border-sky-500/50 transition-colors">
          ...
          <CardContent>
            <p className="text-sm text-zinc-500 mb-4">Configure available leave types (Sick, Annual, etc).</p>
        ...
        <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 shadow-sm hover:border-sky-500/50 transition-colors">
          ...
          <CardContent>
            <p className="text-sm text-zinc-500 mb-4">Set public holidays to exclude them from leave calculations.</p>
