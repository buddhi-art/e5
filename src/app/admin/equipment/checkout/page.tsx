...
export default async function CheckoutEquipmentPage({ searchParams }: { searchParams: Promise<{ equipment_id?: string }> }) {
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto pb-12">
      ...
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white">Check Out Equipment</h1>
        <p className="text-sm text-zinc-500">Assign gear to an employee or project.</p>
      </div>
