      ...
      <Card className="bg-white dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-800 shadow-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2 pt-4 border-t border-zinc-200 dark:border-zinc-800">
            ...
            <Input name="receipt" type="file" accept="image/*,.pdf" className="bg-zinc-50 dark:bg-zinc-800/50" />
            <p className="text-xs text-zinc-500">Upload a scan or photo of the receipt.</p>
          </div>
