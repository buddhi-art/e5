...
const colorMap = {
 ...
 emerald: { bg: 'bg-m3-success-subtle', text: 'text-m3-success', badge: 'bg-m3-success/10 text-m3-success', ring: 'hover:ring-tertiary/30' },
 amber: { bg: 'bg-m3-warning-subtle', text: 'text-m3-warning', badge: 'bg-m3-warning/10 text-m3-warning', ring: 'hover:ring-primary/30' },
}
...
/* ──────────────────────────────────────
 ...
 ────────────────────────────────────── */
export function AdminDashboardClient({ data, insufficientData }: { data: HealthMetrics; insufficientData?: boolean }) {
 const {
 ...
 <h2 className="text-lg font-semibold text-m3-warning mb-1">Insufficient Data</h2>
 ...
 Once data flows in, the health score will self-correct automatically.
 </p>
 ...
 healthScore >= 80 ? 'text-m3-success' : healthScore >= 60 ? 'text-m3-warning' : 'text-m3-error')}>
 <span className={cn('w-1.5 h-1.5 rounded-full animate-pulse',
 healthScore >= 80 ? 'bg-m3-success' : healthScore >= 60 ? 'bg-m3-warning' : 'bg-m3-error')} />
