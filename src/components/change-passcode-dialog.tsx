...
export function ChangePasscodeDialog() {
 ...
 <DialogTrigger
 render={
 <Button variant="ghost" size="sm" className="text-on-surface-variant hover:text-on-surface hover:bg-surface-container-high dark:bg-surface-container">
 ...
 {success && <p className="text-sm text-m3-success">Passcode updated successfully!</p>}
